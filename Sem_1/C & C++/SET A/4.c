/*Write a program to convert an 8-digit number into words (consider both the Indian and
...
char *double_digit_special[] = {"", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"};
